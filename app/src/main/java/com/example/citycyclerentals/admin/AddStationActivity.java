...
public class AddStationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectLocationButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AddStationActivity.this, SelectLocationActivity.class);
    ...
    private void addStation() {
        ...
        String url = "http://192.168.1.2/CityCycle%20Rentals/add_station.php"; // Adjust URL as needed
        Log.d(TAG, "addStation: URL - " + url);
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Toast.makeText(AddStationActivity.this, "Station added successfully", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(AddStationActivity.this, ManageStationsActivity.class);
                        intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK);
                        startActivity(intent);
                        finish(); // Close activity after adding station
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.dismiss();
                        Log.e(TAG, "onErrorResponse: Error adding station", error);
                        ...
                        Toast.makeText(AddStationActivity.this, "Error adding station", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
