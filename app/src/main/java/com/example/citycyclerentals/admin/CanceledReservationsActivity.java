...
public class CanceledReservationsActivity extends AppCompatActivity implements AdminReservationAdapter.OnEditClickListener, AdminReservationAdapter.OnDeleteClickListener, AdminReservationAdapter.OnStatusChangeListener {

    private static final String TAG = "CanceledReservationsActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_canceled_reservations);
    ...
    private class FetchReservationsTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                URL url = new URL("http://192.168.1.2/CityCycle%20Rentals/canceled_reservations.php");
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(CanceledReservationsActivity.this, "Error parsing JSON", Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(CanceledReservationsActivity.this, "Error fetching reservations", Toast.LENGTH_SHORT).show();
            }
        }
    }
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                if (result.trim().equalsIgnoreCase("Reservation updated successfully")) {
                    Toast.makeText(CanceledReservationsActivity.this, result, Toast.LENGTH_SHORT).show();
                    fetchReservations();
                } else {
                    Toast.makeText(CanceledReservationsActivity.this, "Error updating reservation: " + result, Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(CanceledReservationsActivity.this, "Error updating reservation", Toast.LENGTH_SHORT).show();
            }
        }
    }
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                if (result.trim().equalsIgnoreCase("Reservation deleted successfully")) {
                    ...
                    Toast.makeText(CanceledReservationsActivity.this, "Error deleting reservation: " + result, Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(CanceledReservationsActivity.this, "Error deleting reservation", Toast.LENGTH_SHORT).show();
            }
        }
    }
}